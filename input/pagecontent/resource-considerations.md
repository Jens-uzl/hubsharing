...
### Evaluation of Candidate Carrier Paradigms
...
#### Why FHIR Messaging (`Bundle.type = #message`) Was Not Selected
...
#### Why Direct Granular RESTful Resource Access Was Not Selected
...
#### The Mandated Solution: FHIR Document Bundles (`Bundle.type = #document`)
...
### The Role of Contained MHD Comprehensive DocumentReference
